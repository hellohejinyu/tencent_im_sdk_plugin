...
typedef OnGet = Function(List<String> data);

class GroupMemberSelector extends StatefulWidget {
  final String groupID;
  final List<String> values;
  final OnGet onSelect;
  const GroupMemberSelector(this.groupID, this.values, this.onSelect);
  @override
...
class GroupMemberSelectorState extends State<GroupMemberSelector> {
  ...
  getGroupMember() async {
    ...
    for (var element in res.data!.memberInfoList!) {
...
class MemberList extends StatefulWidget {
  ...
  const MemberList(this.members, this.value, this.onSelect);
  @override
...
typedef Onselect = Function(String memberID);

class MemberItem extends StatefulWidget {
  final String memberID;
  final List<String> selected;
  final Onselect onSelect;
  const MemberItem(this.memberID, this.selected, this.onSelect);
