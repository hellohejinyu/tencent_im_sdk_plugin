...
import 'package:example/im/friendApplicationSelector.dart';
...
class AgreeFriendApplicationState extends State<AgreeFriendApplication> {
    ...
    V2TimValueCallback<V2TimFriendOperationResult> res =
        await TencentImSDKPlugin.v2TIMManager
            ...
            .acceptFriendApplication(
              ...
              type: FriendApplicationTypeEnum.values[1],
            ); // 这个1是申请列表里面的type，即application.type
  ...
  Widget build(BuildContext context) {
    String friendType =
        (acceptType == FriendApplicationType.V2TIM_FRIEND_ACCEPT_AGREE_AND_ADD
            ? imt("双向好友")
            : imt("单向好友"));
    return Container(
      child: Column(
